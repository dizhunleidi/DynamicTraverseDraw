...
bool VulkanGraphics::Create() {
    ...
    }
    {
        ...
        wd->PresentMode = ImGui_ImplVulkanH_SelectPresentMode(
            m_PhysicalDevice, wd->Surface, &present_modes[0], IM_ARRAYSIZE(present_modes));
        ...
        ImGui_ImplVulkanH_CreateOrResizeWindow(m_Instance, m_PhysicalDevice, m_Device, wd.get(), m_QueueFamily,
            m_Allocator, (int)m_Width, (int)m_Height, m_MinImageCount);
    }
...
void VulkanGraphics::Render(ImDrawData *drawData) {
    ...
    err = vkAcquireNextImageKHR(
        m_Device, wd->Swapchain, UINT64_MAX, image_acquired_semaphore, VK_NULL_HANDLE, &wd->FrameIndex);
...
BaseTexData *VulkanGraphics::LoadTexture(BaseTexData *tex, void *pixel_data) {
    ...
    tex_data->DS = (void *)ImGui_ImplVulkan_AddTexture(
    ...
    // Copy to Image
    {
        ...
        vkCmdCopyBufferToImage(
            command_buffer, tex_data->UploadBuffer, tex_data->Image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &region);
